...
class checkTeleoperation:
    ...
    def initial_hunter_position(self):
        ...
        hunter_initpose.pose.pose.position.y = -3.2796120643615723
        ...
        hunter_initpose.pose.pose.orientation.z = -0.7057728160297739
        hunter_initpose.pose.pose.orientation.w = 0.7084382345366481
    ...
    def write_to_file(self):
        ...
        np.savez('/home/venkatesh/franka_hunter_ws/src/MobileManip_franka_hunter/franka_hunter_gazebo/script/real_user_1', reference_x = self.save_reference_x, \
            ...
            follower_time = time_array_follower, mobile_time = time_array, mobile_goal = goal, follower_goal = follower_goal, distractors = self.all_distractors)
